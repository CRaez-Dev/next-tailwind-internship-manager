...
const Sidebar = () => {
	...
	return (
		...
		>
			{/* <!-- SIDEBAR HEADER --> */}
			<div className="flex flex-row items-center justify-between lg:justify-center gap2 px-6 py-[12.5px] bg-bodydark2">
				<Link href="/home" className='bg-bodydark2'>
					<Image
				...
				<button
					ref={trigger}
					onClick={() => SidebarStore.changeOpenValue(false)}
